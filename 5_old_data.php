...
$pos=date("h:i:s")."-".strlen($dulux[$q][3])."/".stripos($dulux[$q][3]," – ")."/".strlen(substr($dulux[$q][3],$dlhsie,100))."-".$kontr.",".$kon."-".$p."/".$q;
//$pos=strlen(substr($dulux[76][3],stripos($dulux[76][3]," – ")+3,100));

// list - dpi 
imagettftext( $my_img, $sizeN, 0, $orez*2, $orez*2, $line_colour2 ,$font, $kontr."-".$vyber." ".$pos." ".$dulux[$q][3]);
