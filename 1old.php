<?php
$n=substr(basename(__FILE__),0,1);
$kontr=0;
include "php.php";
...
$pos=strlen($dulux[$q][3])."/".stripos($dulux[$q][3]," – ")."/".strlen(substr($dulux[$q][3],$dlhsie,100))."-".$kontr."-".$p."/".$q;
//$pos=strlen(substr($dulux[76][3],stripos($dulux[76][3]," – ")+3,100));
imagettftext( $my_img, $sizeN, 0, $orez*2, $orez*2, $line_colour2 ,$font, $vyber." ".$pos." ".$dulux[$q][3]);
